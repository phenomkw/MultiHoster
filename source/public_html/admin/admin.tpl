...
The following is general system information and debugging information for <a href="http://en.wikipedia.org/wiki/Power_user#Other_uses"><em>power Mihalism Multi Host users</em></a>.
<br /><br />
            ...
            <tr>
                ...
                <td class="center" valign="top"><input type="text" style="width: 300px;" class="input_field" name="recaptcha_private" value="<# RECAPTCHA_PRIVATE #>" /></td>
							...
							<div class="tab-pane" id="style">
								<s>Style Settings</s> - <i>Depreciated</i>
...
<template id="admin_home_page">
			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-info-sign"></i> New Version!</h2>
					</div>
					<div class="box-content">
						<h3><# UP_TO_DATE #></h3>
						<p></p>
						...
						<p class="center">
							<a href="#" class="btn btn-large btn-primary minfo"><i class="icon-chevron-left icon-white"></i> More Information</a> 
							<a href="" class="btn btn-large"><i class="icon-download-alt"></i> Download</a>
						</p>
						<div class="clearfix"></div>
					</div>
				</div>
